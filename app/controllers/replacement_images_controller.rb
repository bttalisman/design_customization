...
class ReplacementImagesController < ApplicationController
  ...
  def clear_token
    ...
    url = 'http://api.instagram.com/oauth/authorize/?client_id=2b45daba4e154a6cb20060193db7ebfc&redirect_uri=http://armory.bombsheller.net:3000/process_code&response_type=code'
