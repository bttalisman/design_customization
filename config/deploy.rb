...
server 'armory.bombsheller.net', user: 'bent', roles: %w{app web db}
...
set :linked_dirs, fetch(:linked_dirs, []).push('log', 'tmp/pids', 'tmp/cache', 'tmp/sockets', 'public/design_customization')
